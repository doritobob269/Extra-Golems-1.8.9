...
{		
	private int[] goodEffects = {Potion.fireResistance.id,Potion.regeneration.id,Potion.damageBoost.id,Potion.heal.id,Potion.resistance.id,Potion.invisibility.id,Potion.moveSpeed.id};
