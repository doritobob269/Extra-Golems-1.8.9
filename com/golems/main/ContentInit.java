...
public class ContentInit 
{
	...
	public static Block blockPowerSourceFull;	public static final String N_POWER_PROVIDER_FULL = "power_provider_full";
	...
	public static void mainRegistry()
	{
		...
		blockPowerSourceFull = new BlockPowerProvider().setUnlocalizedName(N_POWER_PROVIDER_FULL);
